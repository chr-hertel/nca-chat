...
final readonly class VideoListCommand
{
    ...
    public function __invoke(SymfonyStyle $io, #[Option(description: 'Maximum number of videos')] int $limit = 100): int
    {
        ...
        $videos = 0;
        foreach ($this->videoListing->getVideos($limit) as $video) {
