...
final readonly class Loader
{
     ...
     */
    public function load(int $limit): \Generator
    {
        foreach ($this->videoList->getVideos($limit) as $video) {
            ...
            $document = new TextDocument(Uuid::v4(), $transcript, $metadata);

            yield from $this->splitter->split($document);
        }
    }
}
